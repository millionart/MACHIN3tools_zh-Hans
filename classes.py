...
classes = {"CORE": [("ui.UILists", [("AppendMatsUIList", "")]),
           ...
           "SAVE_PIE": [("ui.pies", [("PieSave", "save_pie")]),
                        ("ui.menus", [("MenuAppendMaterials", "apend_materials")]),
                        ...
                        ("ui.operators.save", [("AppendWorld", "append_world"), ("AppendMaterial", "append_material"), ("LoadWorldSource", "load_world_source"), ("LoadMaterialsSource", "load_material_source")]),
                        ("ui.operators.appendmats", [("Add", "add_appendmat"), ("Move", "move_appendmat"), ("Rename", "rename_appendmat"), ("Clear", "clear_appendmat"), ("Remove", "remove_appendmat")])],
