...
class Focus(bpy.types.Operator):
    ...
    method: EnumProperty(name="模式", items=focus_method_items, default='VIEW_SELECTED')

    levels: EnumProperty(name="多级", items=focus_levels_items, description="在单级 Blender 原生本地视图和多级 MACHIN3 聚焦之间切换", default="MULTIPLE")
